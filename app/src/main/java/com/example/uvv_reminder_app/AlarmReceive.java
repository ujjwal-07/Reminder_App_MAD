...
public class AlarmReceive extends BroadcastReceiver {
    ...
    public AlarmReceive() {}
        ...
        public void onReceive (Context context, Intent intent){
            ...
            showAlarmNotification(context, title, message, notifiId);

        }

        private void showAlarmNotification (Context context, String title, String message,int notidId){
...
//            Uri alarmSound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context, CHANNEL_ID)
                    ...
                    .setVibrate(new long[]{20000})
                    .setSound(Uri.parse("https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3"));
